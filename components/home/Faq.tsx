import {
  ...
  const faqs = [
    {
      id: "item-1",
      question: "What Services Do You Offer For Hijrah?",
    ...
    {
      id: "item-2",
      question: "How Does The Personalized Consultation Work?",
    ...
    {
      id: "item-3",
      question: "What Kind Of Visa And Immigration Help Do You Provide?",
    ...
    {
      id: "item-4",
      question: "Can You Help With Finding A Home In The New Country?",
        ...
        <Accordion type="single" collapsible className="w-full">
          {faqs.map(({ id, question, answer }) => (
            <AccordionItem key={id} value={id}>
              ...
              <AccordionContent className="text-lg text-gray-600 font-normal border-t pt-4 pr-[5%]">{answer}</AccordionContent>
            </AccordionItem>
          ))}
        </Accordion>
